...
<head>
    ...
    <link href="{{ asset('css/internship.css') }}" rel="stylesheet">
    @stack('styles')
</head>
<body>
    <div class="app-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="{{ route('internship.dashboard') }}" class="nav-link {{ request()->routeIs('internship.dashboard') ? 'active' : '' }}">
                    <i class="bi bi-grid-1x2"></i>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('internship.logbook.history') }}" class="nav-link {{ request()->routeIs('internship.logbook.history') ? 'active' : '' }}">
