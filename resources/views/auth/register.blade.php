<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="schools" value="{{ __('School') }}" />
                <x-input id="schools" class="block mt-1 w-full" type="text" name="schools" :value="old('schools')" required autocomplete="organization" />
            </div>
